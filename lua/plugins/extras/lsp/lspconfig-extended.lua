...
return {
  {
    ...
    opts = {
      -- Setup capabilities with the fix for rust-analyzer
      setup = {
        -- This function will run before the standard LazyVim setup
        ["*"] = function(server, opts)
          -- Make sure capabilities have the workspace.didChangeWatchedFiles.dynamicRegistration set to true
        ...
        -- For specific server setup, you can add more here
      },
      diagnostics = {
        virtual_text = {
          float = {
